...
public class Square extends Triangle {
    ...
    public String getSquareCoordsString() {
        String ret="";
        for (int a=0; a<squareCoords.length; a++) {
            if (a>0) ret = ret+", ";
            ret = ret+ String.valueOf(a)+": "+String.valueOf(squareCoords[a]);
    ...
    public void SetCorners(Coord[] corners) {
        if (corners.length == 2) {
            ...
            squareCoords[2] = corners[0].getZ();

            squareCoords[3] = corners[0].getX();
            squareCoords[4] = corners[1].getY();
            squareCoords[5] = corners[0].getZ();

            squareCoords[6] = corners[1].getX();
            squareCoords[7] = corners[1].getY();
            squareCoords[8] = corners[0].getZ();
    ...
    public Square(Coord topleft, float width, float height) {

        SetCorners(new Coord[]{topleft,new Coord(topleft.getX()+width,topleft.getY()+height)});
        BasicSetup();
    }
